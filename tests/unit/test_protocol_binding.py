...
def test_the_binding_covers_every_input_that_changes_the_result():
    ...
    assert {"protocol_sha", "prereg_template_sha", "prereg_frozen_sha", "gates_sha",
            "contracts_sha", "retrieval_freeze_sha", "bench_manifest_sha", "budget_sha",
            "variants_sha", "retrieval_sha", "judge_sha", "week1_sha", "stack_sha",
            "stack_manifest_sha", "vendor_commit", "patched_tree_sha",
